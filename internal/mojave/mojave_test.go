...
func TestQualifiedIdentityRejectsAmbiguityAndLockTampering(t *testing.T) {
	...
	for _, identity := range []string{"arm-092/migrations", "arm092/migrations-more", "arm092/../migrations", "arm092\\migrations", "/migrations", "arm092/", "arm092/migrations/extra", "for/migrations", "arm092/type", "namespace/pkg", "arm092/class", "match/pkg", "arm092/match", "_/migrations"} {
